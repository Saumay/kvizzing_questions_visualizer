  ...
  "$defs": {
    ...
    "DiscussionEntry": {
      "properties": {
        ...
        "has_media": {
          "default": false,
          "description": "True if this discussion message included an image/video/audio/document attachment in the original chat. Only tracked for hint, answer_reveal, and elaboration roles — reaction GIFs and memes in chat/attempt/confirmation entries are intentionally excluded.",
          "title": "Has Media",
          "type": "boolean"
        },
        "media": {
          ...
          "default": null,
          "description": "Media attachments on this discussion message (e.g. an image posted as a hint or an answer reveal image). Null until files are matched and hosted. has_media=True with media=None means: file exists but not yet matched.",
          "title": "Media"
        }
      },
      "required": [
